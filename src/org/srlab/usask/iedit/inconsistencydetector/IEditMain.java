...
public class IEditMain {
	...
	public static void main(String[] args) {
		...
		try {
			...
			try {
				preEditDoc = Jsoup.parse("<p> you cannot use <code><span class=\"diff-delete\">executeUpdate()</span></code> for select queries.....\r\n" + 
						"use <code><span class=\"diff-delete\">executeQuery()</span></code></p>");
			...
			try {
				postEditDoc = Jsoup.parse("<p> you cannot use <span class=\"diff-add\">executeUpdate()</span> for select queries.....\r\n" + 
						"use <span class=\"diff-add\">executeQuery()</span></p>");
